...
type VoteAuthDialogProps = {
  ...
  submittingProvider?: "google" | "github" | null
  authError?: string
}
...
export function VoteAuthDialog({
  ...
  const isGoogleSubmitting = isSubmitting && submittingProvider === "google"
  const isGithubSubmitting = isSubmitting && submittingProvider === "github"

  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton={!isSubmitting} className="max-w-md p-8">
