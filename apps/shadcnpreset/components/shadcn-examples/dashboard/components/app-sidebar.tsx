...
import { NavUser } from "@/components/shadcn-examples/dashboard/components/nav-user";
import {
  DASHBOARD_ANALYTICS_DEMO_HREF,
  DASHBOARD_DEMO_HREF,
} from "@/components/shadcn-examples/dashboard/demo-paths";
