...
const LAYOUT_CLASSES: Record<PreviewLayout, string> = {
  ...
  // Markup that takes its width from its parent — a grid, a table. Wide,
  // because it has columns to spread, and bounded so it does not run the whole
  // canvas.
  wide: "flex min-h-svh items-center justify-center p-6 [&>*]:w-full [&>*]:max-w-3xl",
